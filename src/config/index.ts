...
export const loadConfigVariables = () => {
  ...
  const authMode = env("AUTH_MODE", config.authMode) as AuthMode;
  config.authMode = authMode === "header" ? "header" : "cookie";
